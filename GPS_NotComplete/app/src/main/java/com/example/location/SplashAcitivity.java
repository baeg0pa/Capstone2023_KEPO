...
public class SplashActivity extends AppCompatActivity {
    ...
    public static final int DEFAULT_LOCATION_REQUEST_PRIORITY = LocationRequest.PRIORITY_BALANCED;
    ...
    //사용자로부터 위치 권한을 요청하고, 권한 요청에 대한 결과를 처리하는 함수
    @Override
    ...
    private void checkLocationSetting() { // 위치 설정 확인
        locationRequest = LocationRequest.create(); // 위치요청의 우선순위 및 업데이트 간격 설정 객체
        ...
        SettingsClient settingsClient = LocationServices.getSettingsClient(this); // 위치설정 확인
        LocationSettingsRequest.Builder builder = new LocationSettingsRequest.Builder().addLocationRequest(locationRequest).setAlwaysShow(true); //위치 요청 추가, AlwaysShow 항상 위치설정 표시
